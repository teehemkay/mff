(function (global, factory) {
  ...
  const isDNT = () => navigator.doNotTrack == DNT_YES || navigator.doNotTrack == DNT_ON || navigator.msDoNotTrack == DNT_ON || window.doNotTrack == DNT_ON;
  ...
  const status = () => isDNT() ? DNTED : optedIn() ? OPTED_IN : optedOut() ? OPTED_OUT : NO_CHOICE;
  ...
  const widget = _ref2 => {
    ...
    return _ref3 => {
      ...
      }, optOutLabel)), status !== DNTED && jsx("div", {
        class: "ep_cookies-form-field"
      }, jsx("input", {
        id: "a11y-issue-2",
        name: "cookies-validation",
